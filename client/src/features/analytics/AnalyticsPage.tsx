        ...
        <CardBody>
          <ResponsiveContainer width="100%" height={260}>
            <AreaChart data={trend ?? []} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
              ...
              <YAxis tick={{ fill: '#475569', fontSize: 11 }} tickLine={false} axisLine={false} tickFormatter={(v: number) => compactCurrency(v)} />
              <Tooltip
          ...
          <CardBody>
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={performance ?? []} layout="vertical" margin={{ top: 0, right: 20, left: 10, bottom: 0 }}>
                ...
                <XAxis type="number" tick={{ fill: '#475569', fontSize: 11 }} tickLine={false} axisLine={false} tickFormatter={(v: number) => compactCurrency(v)} />
